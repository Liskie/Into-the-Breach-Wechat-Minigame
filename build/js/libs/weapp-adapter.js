       ...
       */
        ...
        /***/ function (module, exports) {
            ...
            function parse(source, defaultNSMapCopy, entityMap, domBuilder, errorHandler) {
                ...
                function entityReplacer(a) {
                    ...
                    if (k in entityMap) {
                        ...
                        return fixedFromCharCode(parseInt(k.substr(1)
                            .replace('x', '0x')));
                    } else {
                ...
                function appendText(end) {
                    //has some bugs
                    if (end > start) {
                        var xt = source.substring(start, end)
                    ...
                    try {
                        ...
                        switch (source.charAt(tagStart + 1)) {
                            case '/':
                                ...
                                if (end < 0) {
                                    tagName = source.substring(tagStart + 2)
                                        .replace(/[\s<].*/, '');
            ...
            function parseInstruction(source, start, domBuilder) {
                ...
                if (end) {
                    var match = source.substring(start, end)
                        .match(/^<\?(\S*)\s*([\s\S]*?)\s*$/);
                    if (match) {
