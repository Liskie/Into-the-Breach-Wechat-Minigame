...
export default class Game extends Phaser.Scene {
    ...
    loadResources() {
        ...
        this.load.spritesheet(TextureKeys.CarbDeath, 'images/units/aliens/carb_death.png', { frameWidth: TextureProperties.CarbDeathWidth, frameHeight: TextureProperties.CarbDeathHeight });
        this.load.spritesheet(TextureKeys.CarbEmerge, 'images/units/aliens/carb_emerge.png', { frameWidth: TextureProperties.CarbEmergeWidth, frameHeight: TextureProperties.CarbEmergeHeight });
        for (let i = 0; i < 2; i++) {
        ...
        this.load.spritesheet(TextureKeys.BuildingDeath, 'images/buildings/building_B_collapse.png', { frameWidth: TextureProperties.Building_B_collapseWidth, frameHeight: TextureProperties.Building_B_collapseHeight });
        ...
        this.load.spritesheet(TextureKeys.MountainDeath, 'images/buildings/mountain_explode.png', { frameWidth: TextureProperties.MountainDeathWidth, frameHeight: TextureProperties.MountainDeathHeight });
        this.load.spritesheet(TextureKeys.EmergingIntro, 'images/buildings/emerge_intro.png', { frameWidth: 56, frameHeight: 43 });
        this.load.spritesheet(TextureKeys.EmergingLoop, 'images/buildings/emerge_loop.png', { frameWidth: 56, frameHeight: 43 });
        ...
        // portraits
        this.load.spritesheet(TextureKeys.PilotGenius, 'images/pilots/Pilot_Genius_blink.png', { frameWidth: TextureProperties.PilotWidth, frameHeight: TextureProperties.PilotHeight });
        this.load.spritesheet(TextureKeys.PilotLeader, 'images/pilots/Pilot_Leader_blink.png', { frameWidth: TextureProperties.PilotWidth, frameHeight: TextureProperties.PilotHeight });
        this.load.spritesheet(TextureKeys.PilotHotshot, 'images/pilots/Pilot_Hotshot_blink.png', { frameWidth: TextureProperties.PilotWidth, frameHeight: TextureProperties.PilotHeight });
